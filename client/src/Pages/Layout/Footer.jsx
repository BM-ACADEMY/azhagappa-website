...
const Footer = () => {
  ...
  return (
    <section className="bg-[#22324a] text-white py md:py-20">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16 text-left sm:text-left">
          ...
          <div className="lg:col-span-4">
            ...
            {/* Updated Connect With Us */}
<h5 className="mt-8 lg:mt-10 mb-3 text-lg text-[#48b06c] font-semibold tracking-wide">
  Connect With Us
</h5>
<ul className="flex flex-col gap-4 text-sm text-gray-300">
  ...
  <li className="flex items-center gap-2">
    ...
    <a href="mailto:azhagappa8@gmail.com" className="hover:text-[#48b06c]">
      azhagappa8@gmail.com
    </a>
  </li>
  <li className="flex gap-3 items-start">
    <MapPin className="text-[#48b06c] min-w-[20px] mt-1" size={18} />
    <span className="text-sm md:text-base leading-relaxed">
      27, 1st Cross, 1st Floor, Bharkath Nagar, M.G. Road, Kottakuppm (Kaitheye Millath Arch Opp, Villupuram Dist), Tamil Nadu, Puducherry – 605104
    </span>
  </li>
</ul>
          ...
          {menuLinks.map((menu, index) => (
            <div key={index} className="lg:col-span-2">
              <h5 className="mb-3 text-lg text-[#48b06c] font-semibold tracking-wide">
                {menu.title}
              </h5>
