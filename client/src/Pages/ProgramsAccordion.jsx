...
const CourseCard = ({ program, courses }) => (
    <div className="bg-[#234159] rounded-xl p-6 flex flex-col h-[450px] sm:h-[400px] md:h-[450px] min-w-[280px] max-w-[320px] mx-auto shadow-lg">
        <h3 className="text-xl font-bold text-[#05df72] mb-4 text-center">
            {program}
        </h3>
...
const UniversitySection = ({ university }) => {
    ...
    return (
        <div className="rounded-lg p-6 sm:p-8 mb-12">
            <h2 className="text-3xl font-bold text-[#234159] mb-6 text-center">
            ...
            <div className="relative">
                ...
                <div className="flex justify-center gap-4 mt-4">
                    <button
                        className={`swiper-button-prev-${uniqueId} bg-[#234159] text-white p-2 rounded-full hover:bg-[#234159ce] transition-colors duration-200`}
                    ...
                    <button
                        className={`swiper-button-next-${uniqueId} bg-[#234159] text-white p-2 rounded-full hover:bg-[#234159ce] transition-colors duration-200`}
    ...
    <div className="font-inter bg-gray-50 min-h-screen py-10" id='courses'>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="text-center max-w-3xl mx-auto mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-[#234159]">
