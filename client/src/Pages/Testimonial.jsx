...
const reviews = [
  ...
  },
  {
    ...
    rating: 4.8,
    content:
      "The practical approach to learning at PMAT gave me the skills I needed to excel in my internships.",
  },
  {
    name: "M. Lakshmi",
    role: "M.Sc. Graduate",
    rating: 4.7,
    content:
      "The mentorship and resources provided by PMAT were instrumental in my academic success and career growth.",
  },
  {
    name: "V. Arjun",
    role: "BBA",
    rating: 4.9,
    content:
      "PMAT’s flexible learning options allowed me to balance my studies and part-time job effectively.",
  },
];
...
const TestimonialItem = ({ item }) => {
  ...
  return (
    <div className="bg-white rounded-xl h-full duration-300 p-6">
      <div className="mt-4">
...
const Testimonial21 = () => {
  ...
  return (
    <section id="testimonials" className="ezy__testimonial21 py-14 md:py-24 bg-[#efefef] text-zinc-900">
      <div className="container px-4 max-w-6xl mx-auto relative">
        <div className="max-w-6xl mx-auto mb-10 px-4 text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-[#0b245c] mb-4">
            Testimonials
          </h2>
